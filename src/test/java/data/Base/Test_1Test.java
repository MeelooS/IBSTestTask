...
public class Test_1Test {
    ...
    @Description("Программа добавляет товар 'Дуриан' в БД, а затем удаляет его")
    @DisplayName("Тест по БД")
    public void Throne() throws SQLException {
        Connection connection =
                DriverManager.getConnection("jdbc:h2:tcp://149.154.71.152:9092/mem:testdb" ,
                        "user",
                        "pass");
